            ...
            <section className="relative min-h-screen bg-[#050505] text-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
                    ...
                    >
                        ...
                        <span className="text-sm text-gray-300">AI Websites Builder</span>
                    </motion.div>
                    ...
                    >
                        ...
                        <button className="px-6 py-3 border border-white/20 hover:border-white/10 rounded-xl transition">Watch Demo</button>
                    </motion.div>
