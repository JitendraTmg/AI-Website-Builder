...
const Navbar = () => {
    ...
    const logoutHandle = async()=>{
        try {
            await axios.get(`${import.meta.env.VITE_SERVER_URL}/api/auth/logout`,{withCredential:true})
                                ...
                                <div className='relative'>
                                    <button
                                        ...
                                        <img
                                            ...
                                            src={userData ? userData.avatar : "https://ui-avatars.com/api/?name=Jitendra+Tamang"} alt="" className='w-9 h-9 rounded-full border border-white/20 object-cover hover:scale-105 transition' />
                                    </button>
                                    <AnimatePresence>
                                        {openProfile && (
                                            <motion.div
